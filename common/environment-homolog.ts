...
export const environment = {
    ...
    urlamqp: {
        amqpurl: process.env.AMQP_URL || "amqps://xdcjhjem:K_71cgMgEGZh-Yr0yqWQg8sUAIFRAeoh@kebnekaise.lmq.cloudamqp.com/xdcjhjem"
    },
    urlamqpcloud: {
        amqpurlcloud: process.env.AMQP_CLOUD_URL || "amqps://xdcjhjem:K_71cgMgEGZh-Yr0yqWQg8sUAIFRAeoh@kebnekaise.lmq.cloudamqp.com/xdcjhjem"
    },
    ampqkluster: process.env.AMPQ_KLUSTER || "amqps://xdcjhjem:K_71cgMgEGZh-Yr0yqWQg8sUAIFRAeoh@kebnekaise.lmq.cloudamqp.com/xdcjhjem",
    emailservice: {
        url: process.env.EMAIL_SERVICE || "https://apidev.archio.com.br/users"
    },
    db: {
        url: process.env.DB_MONGO || "mongodb://earchiveTester:cdh0tAYUFJXDMB3t@cluster0-shard-00-00-rr6sx.mongodb.net:27017/earchive?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin"
    },
